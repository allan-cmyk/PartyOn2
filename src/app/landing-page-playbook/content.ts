/**
 * Markdown version of the playbook — surfaced via the "Copy as markdown"
 * button so the user can paste this entire document into a new repo, into
 * a Notion doc, or into another AI agent's system prompt as context.
 */
export const MARKDOWN = `# How we built four high-converting landing pages for Party On Delivery
