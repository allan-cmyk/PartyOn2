...
export default function PremiumHome() {
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-yellow-100/50 backdrop-blur-sm px-4 py-2 rounded-full mb-8 hero-fade-in">
                <div className="w-2 h-2 bg-yellow-500 rounded-full animate-pulse" />
                <span className="text-blue-700 text-sm font-medium tracking-wide">AUSTIN&apos;S PREMIER • EST. 2016</span>
              </div>

              {/* Main Heading */}
              <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl text-gray-900 mb-6 leading-[1.1] hero-fade-in">
                Elevate Your
                <span className="block text-yellow-500">Corporate Events</span>
              </h1>
              ...
              <div className="space-y-4 hero-fade-in">
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Link href="/consultation">
                    <button className="group bg-blue-500 hover:bg-brand-blue text-white px-10 py-5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 text-lg font-medium">
                  ...
                  <Link href="/portfolio">
                    <button className="border-2 border-blue-500 text-blue-500 hover:bg-blue-50 px-10 py-5 rounded-full transition-all duration-300 text-lg font-medium">
                      View Portfolio
                    </button>
                  </Link>
                </div>
                ...
                <p className="text-center lg:text-left">
                  <Link href="/download" className="text-brand-blue hover:text-blue-700 text-sm underline">
              ...
              {/* Social Proof */}
              <div className="mt-10 pt-10 border-t border-yellow-200 hero-fade-in">
                <div className="flex items-center justify-center lg:justify-start gap-8">
                  ...
                  <div className="text-sm text-slate-600">
                    <span className="font-semibold text-gray-900">500+</span> Corporate Events
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative lg:ml-12 hero-fade-in">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl bg-yellow-100">
                <Image 
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-xl hero-fade-in">
                  <p className="text-brand-blue font-semibold text-lg mb-2">Next Day Availability</p>
                  <p className="text-slate-600 text-sm mb-3">Full bar service for your executive meetings</p>
                  <Link href="/book" className="text-sm text-brand-yellow hover:text-yellow-600 inline-flex items-center gap-1 font-medium">
                    Check Availability
                  </Link>
                </div>
              </div>
              ...
              {/* Decorative elements */}
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-yellow-100 rounded-full blur-3xl opacity-40" />
              <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-green-100 rounded-full blur-3xl opacity-30" />
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 hero-fade-in">
            <h2 className="font-heading text-5xl md:text-6xl text-gray-900 mb-4">
              Tailored Solutions
            </h2>
                ...
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <p className="text-brand-yellow text-sm font-medium mb-1">{service.subtitle}</p>
                      <h3 className="text-white text-2xl font-heading">{service.title}</h3>
                    </div>
                  </div>
                  <div className="p-8">
                    ...
                    <Link href={`/services/${service.title.toLowerCase().replace(/ /g, '-')}`}>
                      <button className="mt-6 text-brand-blue hover:text-blue-700 font-medium text-sm group-hover:translate-x-2 transition-transform duration-300">
                        Learn More
                      </button>
                    </Link>
                  </div>
      ...
      <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
            ...
            {[
              ...
              >
                <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  {item.icon === 'star' && (
                    <svg className="w-8 h-8 text-brand-yellow fill-current" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                    </svg>
                  )}
                </div>
                <h3 className="text-xl font-medium mb-3 text-brand-yellow">{item.title}</h3>
          ...
          <div className="mt-16 text-center hero-fade-in">
            <Link href="/about">
              <button className="bg-yellow-500 hover:bg-brand-yellow text-gray-900 px-10 py-4 rounded-full font-medium transition-all duration-300">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center hero-fade-in">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                <p className="text-lg font-medium text-gray-900">Sarah Chen</p>
      ...
      {/* CTA Section */}
      <section className="py-32 bg-gradient-to-br from-gray-900 to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="hero-fade-in">
            ...
            <p className="text-2xl mb-12 text-yellow-200 font-light">
              Join Austin&apos;s premier venues in delivering exceptional experiences
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href="/consultation">
                <button className="bg-yellow-500 hover:bg-brand-yellow text-gray-900 px-12 py-5 rounded-full text-xl font-medium transition-all duration-300 transform hover:scale-105 shadow-xl">
                  Schedule Executive Consultation
                </button>
              </Link>
              <Link href="/download">
                <button className="border-2 border-yellow-500 text-brand-yellow hover:bg-yellow-500 hover:text-gray-900 px-12 py-5 rounded-full text-xl font-medium transition-all duration-300">
            ...
            <p className="mt-10 text-brand-yellow">
              ...
              <a href="tel:5125550100" className="text-white font-medium ml-2 hover:text-brand-yellow transition-colors">
                (512) 555-0100
              </a>
            </p>
          </div>
