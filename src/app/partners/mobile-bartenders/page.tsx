...
export default function MobileBartenderPartnerPage() {
  ...
  const testimonials = [
    {
      quote: "I used to spend 3 hours before every event loading my car at Total Wine. Now I show up, set up my bar, and everything's already there cold. Plus the commission checks are a nice bonus.",
      author: "Marcus T.",
      role: "Local Bartender, ATX",
      image: "/images/testimonials/bartender-1-placeholder.jpg" // TODO: Replace with generated image
    },
    {
      quote: "Party On saved my boat party business. Getting alcohol to the dock was always a nightmare. Now it just shows up, and my clients love the selection. Easiest partnership ever.",
      author: "Mix Masters ATX",
      role: "Mobile Bar Service",
      image: "/images/testimonials/bartender-2-placeholder.jpg" // TODO: Replace with generated image
    },
    {
      quote: "The commission alone covers my gas and mileage. Everything else is profit. My clients get better prices than retail, and I get paid for making an intro. Total win-win.",
      author: "DJ & Bartending Co.",
      role: "Austin Event Services",
