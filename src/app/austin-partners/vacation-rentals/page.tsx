          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="font-heading text-xl tracking-wide">Austin Luxury Stays</h1>
            ...
            {categories.map((category, index) => (
              <ScrollRevealCSS key={category.title} duration={800} delay={(index % 8) * 100} y={30}>
                ...
                <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <h3 className="font-heading text-2xl md:text-3xl mb-3 text-gray-900">{category.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              <h3 className="font-heading text-2xl text-gray-900 mb-6">Partner Dashboard</h3>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded border border-gray-200">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm text-gray-600">Monthly Guest Orders</span>
                    <span className="font-heading text-2xl text-gray-900">$4,250</span>
                  </div>
                ...
                <div className="bg-white p-4 rounded border border-gray-200">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-heading text-2xl text-brand-yellow">$425</span>
                  </div>
                </div>
                <div className="bg-white p-4 rounded border border-gray-200">
                  <div className="flex justify-between items-center">
