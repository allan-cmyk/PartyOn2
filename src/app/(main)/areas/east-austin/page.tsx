    ...
    <>
      ...
      <Section>
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Creative District Delivery</h3>
                    <p className="text-sm text-gray-900/60">Studios, galleries, and venue spaces</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Food Truck Court Service</h3>
                    <p className="text-sm text-gray-900/60">Perfect pairings for your food adventures</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-50 rounded-lg p-6">
                <h3 className="font-heading text-xl text-gray-900 mb-4">East Side Favorites</h3>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h4 className="font-semibold text-gray-900 mb-3">🎆 East Austin Events</h4>
                <ul className="space-y-2 text-sm">
                  <li className="flex justify-between">
                    <span className="text-gray-900/70">EAST Austin Studio Tour</span>
                    <span className="text-brand-blue font-medium">November</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-900/70">Fusebox Festival</span>
                    <span className="text-brand-blue font-medium">April</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-900/70">Hot Luck Festival</span>
                    <span className="text-brand-blue font-medium">May</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-900/70">East Austin Food Fest</span>
                    <span className="text-brand-blue font-medium">September</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {/* Service Types */}
          <div className="mb-12">
            <h3 className="font-heading text-2xl text-gray-900 text-center mb-8">East Austin Specials</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="text-3xl mb-4 text-center">🏢</div>
                <h4 className="font-semibold text-gray-900 mb-2">Warehouse Parties</h4>
                <p className="text-sm text-gray-900/70 mb-4">
                  Full bar service for converted warehouse venues and industrial spaces
                </p>
                <ul className="text-xs text-gray-900/60 space-y-1">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-50 rounded-lg shadow-md p-6">
                <div className="text-3xl mb-4 text-center">🎨</div>
                <h4 className="font-semibold text-gray-900 mb-2">Gallery Openings</h4>
                <p className="text-sm text-gray-900/70 mb-4">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="text-3xl mb-4 text-center">🎉</div>
                <h4 className="font-semibold text-gray-900 mb-2">Block Parties</h4>
                <p className="text-sm text-gray-900/70 mb-4">
          ...
          <div className="bg-dark text-white rounded-lg p-8 mb-12">
            <div className="max-w-3xl mx-auto text-center">
              <h3 className="font-heading text-2xl mb-4">Supporting East Austin Culture</h3>
          ...
          <div className="bg-gradient-to-r from-brand-blue to-brand-blue text-white rounded-lg p-8 text-center">
            <h3 className="font-heading text-2xl mb-4">Ready to Party East Side Style?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:7373719700" className="btn-outline border-white text-white hover:bg-white hover:text-gray-900">
