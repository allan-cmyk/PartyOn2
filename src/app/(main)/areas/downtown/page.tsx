        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Delivery Fee: $8-12</h3>
                    <p className="text-sm text-gray-900/60">Based on exact location</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-50 rounded-lg p-8">
              <h3 className="font-heading text-xl text-gray-900 mb-4">Popular Downtown Locations</h3>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Hotels & Venues</h4>
                  <ul className="space-y-1 text-sm text-gray-900/70">
          ...
          {/* Services */}
          <div className="mb-12">
            <h3 className="font-heading text-2xl text-gray-900 text-center mb-8">Downtown Services</h3>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center">
                <div className="text-3xl mb-4">🎶</div>
                <h4 className="font-semibold text-gray-900 mb-2">Festival Support</h4>
                <p className="text-sm text-gray-900/70">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center">
                <div className="text-3xl mb-4">🏆</div>
                <h4 className="font-semibold text-gray-900 mb-2">Game Day Delivery</h4>
                <p className="text-sm text-gray-900/70">
          ...
          <div className="bg-dark text-white rounded-lg p-8 text-center">
            <h3 className="font-heading text-xl mb-4">Event Day Surge?</h3>
