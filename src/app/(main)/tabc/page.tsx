        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="flex items-start space-x-4 mb-6">
              ...
              <div>
                <h3 className="font-heading text-xl text-gray-900 mb-2">TABC License Information</h3>
                <div className="space-y-2 text-gray-900/70">
            ...
            <div className="border-t pt-4">
              <p className="text-sm text-gray-900/60">
                ...
                <a href="https://www.tabc.texas.gov" className="text-brand-blue hover:text-blue-700 ml-1" target="_blank" rel="noopener noreferrer">
                  www.tabc.texas.gov
                </a>
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <h3 className="font-heading text-xl text-gray-900 mb-4">What Our License Means</h3>
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">✓</span>
                  <span className="text-gray-900/70">Authorized to deliver alcohol anywhere in Texas</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">✓</span>
                  <span className="text-gray-900/70">Regular inspections and compliance checks</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">✓</span>
                  <span className="text-gray-900/70">All staff trained in responsible service</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">✓</span>
                  <span className="text-gray-900/70">Strict age verification procedures</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">✓</span>
                  <span className="text-gray-900/70">Full liability insurance coverage</span>
                </li>
              </ul>
            </div>

            <div>
              <h3 className="font-heading text-xl text-gray-900 mb-4">Our Certifications</h3>
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">★</span>
                  <span className="text-gray-900/70">TABC Seller/Server Certification</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">★</span>
                  <span className="text-gray-900/70">Food Handler&apos;s License</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">★</span>
                  <span className="text-gray-900/70">Commercial Auto Insurance</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">★</span>
                  <span className="text-gray-900/70">General Liability Insurance</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-brand-blue mt-1">★</span>
                  <span className="text-gray-900/70">Workers&apos; Compensation Coverage</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-lg p-8 mb-8">
            <h3 className="font-heading text-2xl text-gray-900 mb-6 text-center">Our Compliance Practices</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl mb-3">🆔</div>
                <h4 className="font-semibold text-gray-900 mb-2">100% ID Verification</h4>
              ...
              <div className="text-center">
                <div className="text-3xl mb-3">🚫</div>
                <h4 className="font-semibold text-gray-900 mb-2">Zero Tolerance</h4>
                <p className="text-sm text-gray-900/70">
          ...
          <div className="bg-dark text-white rounded-lg p-8">
            <h3 className="font-heading text-xl mb-4">Legal Notice</h3>
