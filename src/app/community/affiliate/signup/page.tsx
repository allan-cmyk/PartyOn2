...
export default function AffiliateSignupPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Page Header */}
      <div className="bg-gradient-to-r from-brand-yellow via-yellow-500 to-brand-yellow py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading text-4xl sm:text-5xl font-bold text-center tracking-wide mb-4 text-gray-900">
