...
export default function CartSummaryBar(): ReactElement | null {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gold-500 border-t border-gold-600 shadow-lg pb-safe">
      <div className="max-w-7xl mx-auto px-4 py-3">
        <button
          onClick={openCart}
          className="w-full flex items-center justify-between bg-gold-500 hover:bg-gold-400 text-gray-900 rounded-lg px-4 py-3 transition-colors"
        >
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 bg-gray-900 text-gold-500 text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                {itemCount}
              </span>
            </div>
