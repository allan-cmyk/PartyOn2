      ...
      <div className="max-w-6xl mx-auto">
          ...
          <LuxuryCard>
            <div className="p-8">
              <div className="flex items-center mb-6">
                <svg className="w-8 h-8 text-brand-yellow mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-brand-yellow text-gray-900 hover:bg-yellow-600 transition-colors tracking-[0.1em] text-sm font-medium rounded">
              ADD TO CART
            </button>
            <Link
              href="/contact"
