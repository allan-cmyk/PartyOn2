/**
 * @fileoverview Boat Babes hero - split two-column layout
 * @module components/partners/BoatBabesHero
 */
...
export default function BoatBabesHero(): ReactElement {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('/images/partners/boatbabes-hero-bg.jpg')`,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="order-1 text-center">
            <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl text-white mb-4 tracking-wide leading-tight">
              Your Drinks, Iced &amp; Ready for the Lake
            </h1>
          ...
          <div className="order-2 flex flex-col gap-5">
            ...
            <div className="flex items-center justify-center gap-3">
              <Image
                src="/images/partners/boatbabes-logo.jpg"
                alt="Boat Babes"
                width={44}
                height={44}
            ...
            <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-lg border border-white/10">
              <Image
                src="/images/partners/boatbabes-hero.jpg"
                alt="Boat Babes lake party on Lake Austin"
                fill
