/**
 * @fileoverview Connected Austin hero - split two-column layout
 * @module components/partners/ConnectedAustinHero
 */
...
/**
 * Connected Austin hero section - split layout
 * Left: headline, CTAs, group order, phone
 * Right: partner logos, hero image, trust signals
 */
export default function ConnectedAustinHero(): ReactElement {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('/images/partners/connectedaustin-hero-bg.jpg')`,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="order-1 text-center">
            <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl text-white mb-4 tracking-wide leading-tight">
              Your Bachelor Party Drinks, Delivered
            </h1>
            <p className="text-gray-300 text-lg md:text-xl mb-8">
              Stocked at your rental before the weekend kicks off.
            </p>
          ...
          <div className="order-2 flex flex-col gap-5">
            ...
            <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-lg border border-white/10">
              <Image
                src="/images/partners/connectedaustin-hero.jpg"
                alt="Connected Austin bachelor party weekend in Austin"
                fill
