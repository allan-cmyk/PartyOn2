      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 bg-yellow-500 text-gray-900 text-xs font-semibold rounded-lg hover:bg-yellow-400 transition-colors disabled:opacity-50"
          >
                ...
                <div className="mt-auto pt-1">
                  {mp ? (
                    <button
                      ...
                      disabled={isAdding}
                      className="w-full py-1 bg-gray-900 text-white text-xs font-medium rounded hover:bg-gray-800 transition-colors disabled:opacity-50"
                    >
                      {isAdding ? '...' : 'Add'}
                    </button>
                  ) : (
