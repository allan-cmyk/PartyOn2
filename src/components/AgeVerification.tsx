      ...
      <div className="bg-white max-w-md w-full mx-4 p-12 border border-gray-200">
        ...
        <div className="text-center space-y-4 mb-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            You must be 21 years or older to enter this site. Please verify your age to continue.
          </p>
        </div>
        ...
        <p className="mt-8 text-xs text-gray-500 text-center leading-relaxed">
          By entering this site, you agree to our Terms of Service and Privacy Policy, and confirm that you are of legal drinking age in your jurisdiction.
        </p>
