# Pydantic AI Agent Development Rules

This file contains specialized rules for building production-grade AI agents using Pydantic AI. These rules apply **only when building AI agents** - for other project types, use the universal rules and framework-specific guidelines.
...
- **Use a virtual environment** to run all code and tests
...
- **Define structured outputs** - Use Pydantic models for result validation when needed
...
- **Environment variable loading** - Always use load_dotenv()
...
## 📋 Pydantic AI PRP Template Sections

When creating PRPs for Pydantic AI agents, include these specialized sections:

### TOOLS
- Required tool functionality and interfaces
...
### TESTING STRATEGY
- TestModel usage for development
- FunctionModel for custom test scenarios
- Agent.override() patterns
- Validation gates specific to agent behavior

These specialized rules ensure production-ready AI agents with proper error handling, testing, and security practices when using Pydantic AI framework.
